...
public class BasicPrincipal extends JFrame {
	/**
	 * 
	 */
	...
	public BasicPrincipal() {
		...
		JComboBox<String> comboBoxName = new JComboBox<String>();
		...
		JComboBox<String> comboBoxPlace = new JComboBox<String>();
		...
		JComboBox<String> comboBoxRate = new JComboBox<String>();
